import{_ as a,c as n,o as s,e as t}from"./app.c7b97b80.js";const m='{"title":"Home","description":"A customizable accessible carousel slider optimized for Vue","frontmatter":{"home":true,"actionText":"Getting Started \u2192","actionLink":"/getting-started","features":[{"title":"\u{1F9C1} Vue.js","details":"Optimized to work with Vue 3 framework, not a wrapper for another library."},{"title":"\u267F Accessible","details":"Robust structure and Touch, Keyboard, Mouse Wheel, and Navigation support."},{"title":"\u{1F4F1} Responsive","details":"Responsive breakpoints, to apply custom configurations for each screen size."}],"footer":"MIT Licensed","description":"A customizable accessible carousel slider optimized for Vue","meta":[{"name":"og:title","content":"Vue3-carousel"},{"name":"og:description","content":"A customizable accessible carousel slider optimized for Vue 3"}]},"headers":[{"level":2,"title":"Quick Start","slug":"quick-start"},{"level":3,"title":"Installation","slug":"installation"},{"level":3,"title":"Basic Using","slug":"basic-using"}],"relativePath":"index.md","lastUpdated":1613372522539}',e={},p=t(`<h2 id="quick-start" tabindex="-1">Quick Start <a class="header-anchor" href="#quick-start" aria-hidden="true">#</a></h2><h3 id="installation" tabindex="-1">Installation <a class="header-anchor" href="#installation" aria-hidden="true">#</a></h3><p>First step is to install it using <code>yarn</code> or <code>npm</code>:</p><div class="language-bash"><pre><code><span class="token function">npm</span> <span class="token function">install</span> vue3-carousel
